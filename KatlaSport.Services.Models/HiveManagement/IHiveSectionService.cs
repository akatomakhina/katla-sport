...
namespace KatlaSport.Services.HiveManagement
{
    ...
    public interface IHiveSectionService
    {
        ...
        /// <summary>
        /// Creats status for a hive section.
        /// </summary>
        /// <param name="createRequest">Create section request.</param>
        /// <returns>A <see cref="Task"/>.</returns>
